 ...
 */
@ProviderName(name = "jdbc with placeholder")
public class PlaceholderInSqlJdbcDataProvider extends DataProvider implements Aggregatable, Initializing {

    private static final Logger LOG = LoggerFactory.getLogger(PlaceholderInSqlJdbcDataProvider.class);
